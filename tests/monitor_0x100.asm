...
# 0000 tiny_loader
# 0100 monitor_0x100
# 01FF (max size monitor can be because tiny_loader only does one byte length)
# 0200 
# 02DF bottom of data stack. grows into lower addresses. that way ^^^^
# 02FF bottom of call stack. grows into lower addresses. that way ^^^^

# 0400 1K byte line. Commonly used as 'total amount of ram'
